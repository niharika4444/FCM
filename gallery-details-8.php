        ...
        <div class="container">
            ...
            <div class="upper-box">
                <div class="single-item-carousel owl-carousel owl-theme">
                    <figure class="image"><img src="img/gallery/Fuel Aptitude_Championship_with_Fundraising_Concert/C2.jpg" alt="img"></figure>
                </div>
            </div>
                            ...
                            <div class="two-column mt-30 mb-30">
                                <div class="row aling-items-center">
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Fuel Aptitude_Championship_with_Fundraising_Concert/C1.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Fuel Aptitude_Championship_with_Fundraising_Concert/C2.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Fuel Aptitude_Championship_with_Fundraising_Concert/C3.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="info-column col-lg-3 col-md-12 col-sm-12">
                        <div class="inner-column3">
                            ...
                            <ul class="project-info clearfix">
                                ...
                                <li>
                                    <strong>Program:</strong> <span>Fuel Aptitude Championship with Fundraising Concert</span>
                                </li>
