        ...
        <div class="container">
            ...
            <div class="upper-box">
                <div class="single-item-carousel owl-carousel owl-theme">
                    <figure class="image"><img src="img/gallery/Talent Search_Scholarship_Program/T1.jpg" alt="img"></figure>
                </div>
            </div>
                        ...
                        <div class="s-about-content wow fadeInRight" data-animation="fadeInRight" data-delay=".2s">
                            ...
                            <div class="two-column mt-30 mb-30">
                                <div class="row aling-items-center">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T2.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T3.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T4.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T5.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T6.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T7.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T10.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T11.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T13.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T14.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T15.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T16.jpg" alt="img">
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12 mt-30">
                                        <img src="img/gallery/Talent Search_Scholarship_Program/T17.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="info-column col-lg-3 col-md-12 col-sm-12">
                        <div class="inner-column3">
                            ...
                            <ul class="project-info clearfix">
                                ...
                                <li>
                                    <strong>Program:</strong> <span>Talent Search Scholarship Program</span>
                                </li>
